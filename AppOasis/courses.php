...
if (!isset($_GET['order-by'])) {
    ...
    $newUrl = $currentUrl . $separator . 'order-by=desc';
        ...
        <div>My Account</div>
                ...
                <main>
                    ...
                    <section class="title-section">
                        ...
                        <p>Ignite your potential with our dynamic courses. From coding and design to business and
                            personal development, we offer a diverse selection of expert-led courses. Unleash your
                            curiosity, acquire new skills, and unlock exciting opportunities.</p>
                    ...
                    <section class="navigation-section">
                            ...
                            <form class="content-form">
                                ...
                                <div class="form-fieldset">
                                    ...
                                    <fieldset>
                                        ...
                                        <p>Discover the perfect course for you! Utilize our search form to find the
                                            ideal learning opportunity. Explore categories, enter keywords to narrow
                                            down your choices. Start your educational journey now!</p>

                                        <input type="text" id="search-text" />

                                        <button type="button" class="btn" onclick="SearchForSomething();">
                        ...
                        <section class="general-categories-section">
                            ...
                            <form class="content-form">
                                ...
                                <div class="form-fieldset">
                                    ...
                                    <ul style="padding: 0; margin: 0; width: 100%; margin-top: 20px;">
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<li><button onclick=\"window.location.href = 'courses.php?category=" . urlencode($row['name']) . "'\" type='button' class='btn' style='background-color: royalblue; color: white; border-radius: 40px;'>" . $row['name'] . "</button></li>";
                        ...
                        <ul>
                            ...
                            <li><button type="button" onclick="window.location.href='courses.php';">All</button></li>
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<li><button onclick=\"window.location.href = 'courses.php?category=" . urlencode($row['name']) . "'\" type='button'>" . $row['name'] . "</button></li>";
                    ...
                    <section class="content-section">
                        ...
                        <ul class="courses-grid">
                            ...
                            if (isset($_GET['category'])) {
                                ...
                                $sql = "SELECT * FROM Courses where category_id = (select id from categories WHERE lower(trim(name)) = lower(trim('" . $category_name . "')))";
                                ...
                                if (isset($_GET['search-query'])) {
                                    ...
                                    $sql .= " where (lower(trim(short_title)) like lower(trim('%" . $searchQuery . "%')) or lower(trim(`long_title`)) like lower(trim('%" . $searchQuery . "%')) or lower(trim(`description`)) like lower(trim('%" . $searchQuery . "%')))";
